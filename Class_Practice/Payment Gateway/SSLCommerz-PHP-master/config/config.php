...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'http://localhost/PWAD-68/PWAD-68_PHP_Practice/Class_Practice/Payment%20Gateway/SSLCommerz-PHP-master'); // replace this value with your project path
}
...
if (!defined('STORE_ID')) {
    define('STORE_ID', 'tod694f532bebaa0'); // your store id. For sandbox, register at https://developer.sslcommerz.com/registration/
}

if (!defined('STORE_PASSWORD')) {
    define('STORE_PASSWORD', 'tod694f532bebaa0@ssl'); // your store password.
}
